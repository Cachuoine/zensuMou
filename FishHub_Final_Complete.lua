...
local function CreateTabContent(name)
    ...
    elseif name == "Function" then
        ...
        local function CreateCategoryCard(title, icon, desc, order)
            ...
            card.MouseButton1Click:Connect(function()
                ...
                LoadFeatureScript(title)

                subPageTitle.Text = icon .. "  " .. title

                if url ~= "" then
                    subPageContentText.Text =
                        "Module: " .. title ..
                        "\n\nStatus: " .. (LoadedFeatureModules[title] and "Loaded" or "Ready") ..
                        "\nRemote implementation is isolated from the main UI." ..
                        "\n\nSearch and Back are already provided by FishHub." ..
                        "\nTo update this feature, replace only its URL."
                else
                    subPageContentText.Text =
                        "Module: " .. title ..
                        "\n\nStatus: URL not configured" ..
                        "\n\nPaste the raw GitHub URL into FeatureScripts." ..
                        "\nThe main UI does not need to be changed." ..
                        "\n\nSearch and Back are already provided by FishHub."
                end
    ...
    elseif name == "Creative" then
        ...
        paddingFrame.Size = UDim2.new(1, 0, 0, 12)
        ...
        joinCard.Size = UDim2.new(0.92, 0, 0, 112)
        ...
        tabFrame.CanvasSize = UDim2.new(0, 0, 0, 380)
    else
