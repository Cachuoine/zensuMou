--[[
    server.lua
    FishHub-BloxFruit | Server Module
...
local TABS = {
    {
        key     = "islandeven",
        title   = "Island Event",
        subtitle= "Server-wide events & islands",
        icon    = "🏝",
        url     = "https://raw.githubusercontent.com/Cachuoine/zensuMou/refs/heads/main/FishHub-BloxFruit/s1/server/islandeven.lua",
        accent  = Color3.fromRGB(80, 200, 255),
    },
    {
        key     = "boss",
        title   = "Boss",
        subtitle= "World & raid bosses",
        icon    = "👑",
        url     = "https://raw.githubusercontent.com/Cachuoine/zensuMou/refs/heads/main/FishHub-BloxFruit/s1/server/boss.lua",
        accent  = Color3.fromRGB(255, 90, 120),
    },
    {
        key     = "miss",
        title   = "Misc",
        subtitle= "Other server features",
        icon    = "✨",
        url     = "https://raw.githubusercontent.com/Cachuoine/zensuMou/refs/heads/main/FishHub-BloxFruit/s1/server/missserver.lua",
...
local searchInput = New("TextBox", {
    ...
    PlaceholderText = "Search in server...",
...
local rTitle = New("TextLabel", { Parent = rHeader, Position = UDim2.new(0, 58, 0, 4), Size = UDim2.new(1, -120, 0, 24), BackgroundTransparency = 1, Font = Enum.Font.GothamBold, TextSize = 16, TextColor3 = C.textMain, TextXAlignment = Enum.TextXAlignment.Left, Text = "Server" })
