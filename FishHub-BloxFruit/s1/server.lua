...
-- CONFIG
-- ============================================
local SECTION_TITLE = "SERVER"
local TABS = {
    { name = "Island Event", url = "https://raw.githubusercontent.com/Cachuoine/zensuMou/refs/heads/main/FishHub-BloxFruit/s1/server/islandeven.lua" },
...
-- ============================================
-- CLEAR TAB (no scrollbar, no effect on parent)
-- ============================================
...
New("UIGradient", {
    ...
    Color = ColorSequence.new({
        ...
        ColorSequenceKeypoint.new(0.6, Color3.fromRGB(10, 11, 17)),
...
local headerFrame = New("Frame", {
    Parent = leftMenu,
    Position = UDim2.new(0, 12, 0, MENU_PAD_TOP),
    Size = UDim2.new(1, -24, 0, HEADER_HEIGHT),
    BackgroundTransparency = 1,
})
...
local headerLine = New("Frame", {
    Parent = leftMenu,
    Position = UDim2.new(0, 12, 0, MENU_PAD_TOP + HEADER_HEIGHT + 2),
...
for i, tabData in ipairs(TABS) do
    ...
    local btn = New("TextButton", {
        ...
        Size = UDim2.new(1, -16, 0, BUTTON_HEIGHT),
        BackgroundColor3 = Color3.fromRGB(15, 16, 23),
    ...
    New("UIGradient", {
        ...
        Rotation = 90,
        Color = ColorSequence.new({
            ColorSequenceKeypoint.new(0, Color3.fromRGB(22, 24, 32)),
...
-- Vertical line indicator (kẻ dọc)
local indicatorY0 = tabStartY + INDICATOR_INSET
local indicator = New("Frame", {
    Parent = leftMenu,
    Position = UDim2.new(0, INDICATOR_X, 0, indicatorY0),
    Size = UDim2.new(0, INDICATOR_WIDTH, 0, BUTTON_HEIGHT - INDICATOR_INSET * 2),
...
local indicatorGlow = New("Frame", {
    Parent = leftMenu,
    Position = UDim2.new(0, INDICATOR_X - 2, 0, indicatorY0 - 3),
    Size = UDim2.new(0, INDICATOR_WIDTH + 4, 0, BUTTON_HEIGHT - INDICATOR_INSET * 2 + 6),
    BackgroundColor3 = accent(),
...
-- Soft pulse on the glow
task.spawn(function()
    while indicator and indicator.Parent do
        Tween(indicatorGlow, 0.9, {
            BackgroundTransparency = 0.55,
            Size = UDim2.new(0, INDICATOR_WIDTH + 6, 0, BUTTON_HEIGHT - INDICATOR_INSET * 2 + 10),
...
local rightContent = New("Frame", {
    Parent = mainArea,
    Position = UDim2.new(0.28, 8, 0, 0),
    Size = UDim2.new(0.72, -8, 0, 0),
    AutomaticSize = Enum.AutomaticSize.Y,
...
local function setActive(index)
    ...
    -- Slide the vertical line to the new tab (smooth, no delay)
