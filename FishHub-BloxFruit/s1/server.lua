...
-- Configuration
------------------------------------------------------------
local PAGE_TITLE = "SERVER"
local TABS = {
    {
        name = "Island Even",
        url  = "https://raw.githubusercontent.com/Cachuoine/zensuMou/refs/heads/main/FishHub-BloxFruit/s1/server/islandeven.lua",
        desc = "Island event utilities",
        body = "Island event module loaded. Provides utilities for island-based content and quick travel between event locations."
    },
    {
        name = "Boss",
        url  = "https://raw.githubusercontent.com/Cachuoine/zensuMou/refs/heads/main/FishHub-BloxFruit/s1/server/boss.lua",
        desc = "Boss finder and helpers",
        body = "Boss module loaded. Helpers for finding, tracking, and engaging with world bosses and raid targets."
    },
    {
        name = "Miss",
        url  = "https://raw.githubusercontent.com/Cachuoine/zensuMou/refs/heads/main/FishHub-BloxFruit/s1/server/missserver.lua",
        desc = "Miscellaneous server tools",
        body = "Miscellaneous server tools loaded. Catch-all helpers that don't belong to a dedicated tab."
    },
}
...
------------------------------------------------------------
-- Accent color updater (RenderStepped → no delay)
------------------------------------------------------------
local connection
...
------------------------------------------------------------
-- Auto-select first tab (no animation)
------------------------------------------------------------
task.defer(function()
    if #TABS > 0 then
        selectTab(1, false)
