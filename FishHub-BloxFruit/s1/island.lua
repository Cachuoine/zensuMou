--[[
    island.lua
    Module: Island (single content, no tabs)
...
local searchInput = new("TextBox", {
    ...
    PlaceholderText = "search...", PlaceholderColor3 = Color3.fromRGB(100, 105, 120),
...
new("TextLabel", {
    ...
    Text = "Island", Font = Enum.Font.GothamBold, TextSize = 18,
    TextColor3 = Color3.fromRGB(240, 242, 248), TextXAlignment = Enum.TextXAlignment.Left,
})
new("TextLabel", {
...
-- Optional: hand the content holder to the framework so it can populate it
if type(context.LoadContent) == "function" then
    pcall(context.LoadContent, { Name = "Island" }, contentHolder)
end
