...
-- Configuration
------------------------------------------------------------
local PAGE_TITLE = "TELEPORT"
local TABS = {
    {
        name = "Island",
        url  = "https://raw.githubusercontent.com/Cachuoine/zensuMou/refs/heads/main/FishHub-BloxFruit/s1/teleport/island.lua",
        desc = "Island travel and warp",
        body = "Island teleport module loaded. Quick-travel between islands and event locations."
    },
    {
        name = "NPC",
        url  = "https://raw.githubusercontent.com/Cachuoine/zensuMou/refs/heads/main/FishHub-BloxFruit/s1/teleport/npc.lua",
        desc = "NPC teleport",
        body = "NPC teleport module loaded. Jump to quest NPCs, merchants, and special characters."
    },
}
