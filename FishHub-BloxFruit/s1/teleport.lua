...
if PlayerGui:FindFirstChild("FishHub_TeleportUI") then
    PlayerGui.FishHub_TeleportUI:Destroy()
end

local ScreenGui = Instance.new("ScreenGui")
ScreenGui.Name = "FishHub_TeleportUI"
...
SearchBox.PlaceholderText = "Tìm kiếm teleport..."
SearchBox.Text = ""
