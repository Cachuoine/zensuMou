...
-- ============================================================
local TABS = {
    { key="farm",    title="Farm",    subtitle="Auto-farm mobs & quests",  icon="🌾", url="https://raw.githubusercontent.com/Cachuoine/zensuMou/refs/heads/main/FishHub-BloxFruit/s1/farm/farm.lua",    accent=Color3.fromRGB(120, 230, 160) },
    { key="fishing", title="Fishing", subtitle="Auto-fish & catch events", icon="🎣", url="https://raw.githubusercontent.com/Cachuoine/zensuMou/refs/heads/main/FishHub-BloxFruit/s1/farm/fishing.lua", accent=Color3.fromRGB(80, 200, 255) },
    { key="miss",    title="Misc",    subtitle="Other farm tools",         icon="✨", url="https://raw.githubusercontent.com/Cachuoine/zensuMou/refs/heads/main/FishHub-BloxFruit/s1/farm/missfarm.lua", accent=Color3.fromRGB(255, 170, 60) },
}
...
local rTitle = New("TextLabel", { Parent = rHeader, Position = UDim2.new(0, 52, 0, 6),  Size = UDim2.new(1, -120, 0, 22), BackgroundTransparency = 1, Font = Enum.Font.GothamBold,   TextSize = 15, TextColor3 = C.textMain, TextXAlignment = Enum.TextXAlignment.Left, Text = "Farm" })
