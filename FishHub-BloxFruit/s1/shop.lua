...
if PlayerGui:FindFirstChild("FishHub_ShopUI") then
    PlayerGui.FishHub_ShopUI:Destroy()
end

local ScreenGui = Instance.new("ScreenGui")
ScreenGui.Name = "FishHub_ShopUI"
...
SearchBox.PlaceholderText = "Tìm kiếm cửa hàng..."
SearchBox.Text = ""
