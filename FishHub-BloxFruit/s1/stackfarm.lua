...
if PlayerGui:FindFirstChild("FishHub_StackFarmUI") then
    PlayerGui.FishHub_StackFarmUI:Destroy()
end

local ScreenGui = Instance.new("ScreenGui")
ScreenGui.Name = "FishHub_StackFarmUI"
...
SearchBox.PlaceholderText = "Tìm kiếm stack farm..."
SearchBox.Text = ""
