--[[ 
    FishHub Blox Fruit - stackfarm.lua
    Boss man, updated with tabs: item, quest.
]]--
...
local displayText = New("TextLabel", { Parent = contentScroll, Size = UDim2.new(1, 0, 0, 200), BackgroundTransparency = 1, Text = "Select a stackfarm tab...", Font = Enum.Font.GothamMedium, TextSize = 13, TextColor3 = Color3.fromRGB(200, 205, 220), TextWrapped = true, TextXAlignment = Enum.TextXAlignment.Left, TextYAlignment = Enum.TextYAlignment.Top })
...
for _, data in ipairs(tabsData) do
    ...
    tabBtn.Activated:Connect(function()
        ...
        displayText.Text = "Loading stack data..."
        task.spawn(function()
