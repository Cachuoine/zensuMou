...
-- Configuration
------------------------------------------------------------
local PAGE_TITLE = "STACK FARM"
local TABS = {
    {
        name = "Item",
        url  = "https://raw.githubusercontent.com/Cachuoine/zensuMou/refs/heads/main/FishHub-BloxFruit/s1/stackfarm/item.lua",
        desc = "Item stack and inventory",
        body = "Item stack module loaded. Track inventory, stacks, and item-related farm actions."
    },
    {
        name = "Quest",
        url  = "https://raw.githubusercontent.com/Cachuoine/zensuMou/refs/heads/main/FishHub-BloxFruit/s1/stackfarm/quest.lua",
        desc = "Quest stack and tracker",
        body = "Quest stack module loaded. Track quest progress, accepted quests, and auto-claim rewards."
    },
}
