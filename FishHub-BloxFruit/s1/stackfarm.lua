--[[
    stackfarm.lua
    FishHub-BloxFruit | Stack Farm Module
    v2 — bugfixes applied
]]
...
-- ============================================================
local TABS = {
    { key="item",  title="Item",  subtitle="Stack items & inventory", icon="📦", url="https://raw.githubusercontent.com/Cachuoine/zensuMou/refs/heads/main/FishHub-BloxFruit/s1/stackfarm/item.lua",  accent=Color3.fromRGB(255, 200, 90) },
    { key="quest", title="Quest", subtitle="Auto-quest & rewards",   icon="📜", url="https://raw.githubusercontent.com/Cachuoine/zensuMou/refs/heads/main/FishHub-BloxFruit/s1/stackfarm/quest.lua", accent=Color3.fromRGB(170, 90, 255) },
}
...
local rTitle = New("TextLabel", { Parent = rHeader, Position = UDim2.new(0, 52, 0, 6),  Size = UDim2.new(1, -120, 0, 22), BackgroundTransparency = 1, Font = Enum.Font.GothamBold,   TextSize = 15, TextColor3 = C.textMain, TextXAlignment = Enum.TextXAlignment.Left, Text = "Stack Farm" })
