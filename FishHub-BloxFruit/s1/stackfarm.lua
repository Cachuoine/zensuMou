...
local TABS = {
    {
        key     = "item",
        title   = "Item",
        subtitle= "Stack items & inventory",
        icon    = "📦",
        url     = "https://raw.githubusercontent.com/Cachuoine/zensuMou/refs/heads/main/FishHub-BloxFruit/s1/stackfarm/item.lua",
        accent  = Color3.fromRGB(255, 200, 90),
    },
    {
        key     = "quest",
        title   = "Quest",
        subtitle= "Auto-quest & rewards",
        icon    = "📜",
        url     = "https://raw.githubusercontent.com/Cachuoine/zensuMou/refs/heads/main/FishHub-BloxFruit/s1/stackfarm/quest.lua",
...
local searchInput = New("TextBox", {
    ...
    PlaceholderText = "Search in stack farm...",
...
local rTitle = New("TextLabel", { Parent = rHeader, Position = UDim2.new(0, 58, 0, 4), Size = UDim2.new(1, -120, 0, 24), BackgroundTransparency = 1, Font = Enum.Font.GothamBold, TextSize = 16, TextColor3 = C.textMain, TextXAlignment = Enum.TextXAlignment.Left, Text = "Stack Farm" })
