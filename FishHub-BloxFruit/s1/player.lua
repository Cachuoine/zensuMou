...
-- Configuration
------------------------------------------------------------
local PAGE_TITLE = "PLAYER"
local TABS = {
    {
        name = "Player",
        url  = "https://raw.githubusercontent.com/Cachuoine/zensuMou/refs/heads/main/FishHub-BloxFruit/s1/player/player.lua",
        desc = "Player utilities and helpers",
        body = "Player module loaded. Helpers for movement, stats, and player-specific actions."
    },
    {
        name = "PvP",
        url  = "https://raw.githubusercontent.com/Cachuoine/zensuMou/refs/heads/main/FishHub-BloxFruit/s1/player/pvp.lua",
        desc = "PvP utilities",
        body = "PvP module loaded. Combat helpers, target tracking, and duel utilities are active."
    },
}
