...
local TABS = {
    {
        key     = "settingfarm",
        title   = "Setting Farm",
        subtitle= "Configure farm behaviour",
        icon    = "⚙",
        url     = "https://raw.githubusercontent.com/Cachuoine/zensuMou/refs/heads/main/FishHub-BloxFruit/s1/settingfarm/misssettingfarm.lua",
        accent  = Color3.fromRGB(255, 170, 60),
    },
    {
        key     = "holdselect",
        title   = "Hold & Select Skill",
        subtitle= "Keybinds & skill slots",
        icon    = "🎯",
        url     = "https://raw.githubusercontent.com/Cachuoine/zensuMou/refs/heads/main/FishHub-BloxFruit/s1/settingfarm/hold%26selectskill.lua",
...
local rTitle = New("TextLabel", { Parent = rHeader, Position = UDim2.new(0, 58, 0, 4), Size = UDim2.new(1, -120, 0, 24), BackgroundTransparency = 1, Font = Enum.Font.GothamBold, TextSize = 16, TextColor3 = C.textMain, TextXAlignment = Enum.TextXAlignment.Left, Text = "Setting Farm" })
