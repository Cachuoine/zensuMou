--[[
    settingfarm.lua
    Module: SETTING FARM
    Tabs: Setting Farm, Hold & Select Skill
]]
...
local TABS = {
    {
        ...
        desc = "Farm preferences and config",
        body = "Farm settings module loaded. Configure target selection, ranges, and farm behavior here."
    },
    {
        name = "Hold & Select Skill",
        ...
        desc = "Skill keybind and hold mode",
        body = "Hold and select skill module loaded. Bind keys, configure hold-mode behavior, and pick active skills."
    },
}
