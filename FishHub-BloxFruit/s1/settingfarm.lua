...
-- CONFIG
-- ============================================
local SECTION_TITLE = "FARM CONFIG"
local TABS = {
    ...
    { name = "Hold & Select",    url = "https://raw.githubusercontent.com/Cachuoine/zensuMou/refs/heads/main/FishHub-BloxFruit/s1/settingfarm/hold%26selectskill.lua" },
}
