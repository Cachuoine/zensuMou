...
New("TextLabel", { Parent = contentFrame, Size = UDim2.fromScale(1, 1), BackgroundTransparency = 1, Text = "Setting Farm Preferences & Configs", Font = Enum.Font.GothamBold, TextSize = 14, TextColor3 = Color3.fromRGB(200, 205, 220) })

backBtn.Activated:Connect(function()
    if type(context.BackToMain) == "function" then context.BackToMain() 
    elseif type(context.Navigate) == "function" then context.Navigate("Function") end
end)
