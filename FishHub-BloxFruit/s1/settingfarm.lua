...
if PlayerGui:FindFirstChild("FishHub_SettingFarmUI") then
    PlayerGui.FishHub_SettingFarmUI:Destroy()
end

local ScreenGui = Instance.new("ScreenGui")
ScreenGui.Name = "FishHub_SettingFarmUI"
...
SearchBox.PlaceholderText = "Tìm kiếm cài đặt..."
SearchBox.Text = ""
