...
New("TextBox", { Parent = searchBox, Position = UDim2.new(0, 35, 0, 0), Size = UDim2.new(1, -45, 1, 0), BackgroundTransparency = 1, ClearTextOnFocus = false, PlaceholderText = "Search settings farm...", PlaceholderColor3 = Color3.fromRGB(100, 105, 120), Text = "", Font = Enum.Font.GothamMedium, TextSize = 11, TextColor3 = Color3.fromRGB(240, 242, 248), TextXAlignment = Enum.TextXAlignment.Left })
