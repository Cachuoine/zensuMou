--[[ 
    FishHub Blox Fruit - settingfarm.lua
    Boss man, updated with tabs: setting farm, hold & select skill.
]]--
...
local displayText = New("TextLabel", { Parent = contentScroll, Size = UDim2.new(1, 0, 0, 200), BackgroundTransparency = 1, Text = "Select a setting tab...", Font = Enum.Font.GothamMedium, TextSize = 13, TextColor3 = Color3.fromRGB(200, 205, 220), TextWrapped = true, TextXAlignment = Enum.TextXAlignment.Left, TextYAlignment = Enum.TextYAlignment.Top })
...
for _, data in ipairs(tabsData) do
    local tabBtn = New("TextButton", { Parent = menuFrame, Size = UDim2.new(1, 0, 0, 38), BackgroundColor3 = Color3.fromRGB(18, 20, 30), AutoButtonColor = false, Text = data.Name:upper(), Font = Enum.Font.GothamBold, TextSize = 10, TextColor3 = Color3.fromRGB(180, 185, 200) })
    Corner(tabBtn, 8)
    Stroke(tabBtn, 1, 0.7)
    ...
    tabBtn.Activated:Connect(function()
        ...
        displayText.Text = "Loading setting configurations..."
        task.spawn(function()
