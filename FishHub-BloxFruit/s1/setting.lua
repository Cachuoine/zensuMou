...
-- Configuration
------------------------------------------------------------
local PAGE_TITLE = "SETTING"
local TABS = {
    {
        name = "Config",
        url  = "https://raw.githubusercontent.com/Cachuoine/zensuMou/refs/heads/main/FishHub-BloxFruit/s1/setting/config.lua",
        desc = "General configuration",
        body = "Config module loaded. Manage general FishHub settings, toggles, and preferences."
    },
    {
        name = "Theme UI",
        url  = "https://raw.githubusercontent.com/Cachuoine/zensuMou/refs/heads/main/FishHub-BloxFruit/s1/setting/themeUI.lua",
        desc = "UI theme and accent",
        body = "Theme UI module loaded. Switch accent colors, toggle rainbow mode, and tune visuals."
    },
}
