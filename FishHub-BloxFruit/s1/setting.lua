--[[
    setting.lua
    Module: Setting (single content, no tabs)
...
local searchInput = new("TextBox", {
    ...
    PlaceholderText = "search settings...", PlaceholderColor3 = Color3.fromRGB(100, 105, 120),
...
new("TextLabel", {
    ...
    Text = "Setting", Font = Enum.Font.GothamBold, TextSize = 18,
    TextColor3 = Color3.fromRGB(240, 242, 248), TextXAlignment = Enum.TextXAlignment.Left,
})
new("TextLabel", {
...
if type(context.LoadContent) == "function" then
    pcall(context.LoadContent, { Name = "Setting" }, contentHolder)
end
