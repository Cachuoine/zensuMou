...
if PlayerGui:FindFirstChild("FishHub_FruitUI") then
    PlayerGui.FishHub_FruitUI:Destroy()
end

local ScreenGui = Instance.new("ScreenGui")
ScreenGui.Name = "FishHub_FruitUI"
...
SearchBox.PlaceholderText = "Tìm kiếm fruit..."
SearchBox.Text = ""
