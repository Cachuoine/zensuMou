...
-- Configuration
------------------------------------------------------------
local PAGE_TITLE = "FRUIT"
local TABS = {
    {
        name = "Dealer",
        url  = "https://raw.githubusercontent.com/Cachuoine/zensuMou/refs/heads/main/FishHub-BloxFruit/s1/fruit/dealer.lua",
        desc = "Fruit dealer module",
        body = "Fruit dealer module loaded. Browse, purchase, and manage dealer interactions."
    },
    {
        name = "Fruit",
        url  = "https://raw.githubusercontent.com/Cachuoine/zensuMou/refs/heads/main/FishHub-BloxFruit/s1/fruit/fruit.lua",
        desc = "Fruit inventory and info",
        body = "Fruit module loaded. Track fruit inventory, view stats, and fruit-related helpers."
    },
    {
        name = "Raid",
        url  = "https://raw.githubusercontent.com/Cachuoine/zensuMou/refs/heads/main/FishHub-BloxFruit/s1/fruit/raid.lua",
        desc = "Raid module",
        body = "Raid module loaded. Helpers for fruit raids, chip management, and raid tokens."
    },
}
