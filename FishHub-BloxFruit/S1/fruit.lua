--[[
    FRUIT - FishHub standalone module
...
local GUI_NAME = "FishHub_fruitlua"
...
local cards = {}
local featureList = {
    {"Fruit controls", "Fruit collection / selection controls"},
...
print("[FishHub] FRUIT standalone module loaded")
