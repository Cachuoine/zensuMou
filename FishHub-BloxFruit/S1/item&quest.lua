--[[
    ITEM & QUEST - FishHub standalone module
...
local GUI_NAME = "FishHub_itemandquestlua"
...
local cards = {}
local featureList = {
    {"Quest controls", "Quest and item controls"},
...
print("[FishHub] ITEM & QUEST standalone module loaded")
