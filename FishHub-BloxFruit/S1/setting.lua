--[[
    SETTING - FishHub standalone module
...
local GUI_NAME = "FishHub_settinglua"
...
local cards = {}
local featureList = {
    {"Hub settings", "Module-specific configuration controls"},
...
print("[FishHub] SETTING standalone module loaded")
