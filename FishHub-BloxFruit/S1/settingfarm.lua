--[[
    SETTING FARM - FishHub standalone module
...
local GUI_NAME = "FishHub_settingfarmlua"
...
local cards = {}
local featureList = {
    {"Farm settings", "Configure farm targets and behavior"},
...
print("[FishHub] SETTING FARM standalone module loaded")
