...
local function CreateTabContent(name)
    ...
    if name == "Home" then
        -- Home intentionally contains only the Welcome card.
    ...
    elseif name == "Function" then
        -- Function intentionally remains as a selectable empty tab.
        -- All navigation and external function hooks remain untouched.
