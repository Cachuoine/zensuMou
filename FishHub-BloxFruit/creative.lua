...
-- Không còn đường kẻ + chữ FISHHUB - CREATIVE ở cuối.
-- Discord / Facebook / TikTok dùng nút TRÒN.
-- Avatar @thankhuyenhuy được resolve bằng username rồi mới lấy thumbnail.
