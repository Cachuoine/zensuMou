...
-- Forward declaration để hàm render function có thể tự gọi lại chính nó khi bấm nút Back
...
renderFunctionMenu = function()
    ...
    local function loadModule(fileName)
        ...
        if success and result then
            ...
            if fn then
                -- Đưa hàm renderFunctionMenu vào context để file con gọi khi bấm nút Back
