return function(context)
    ...
    local function applyTheme()
        ...
        -- Commit the selected color immediately. No loading screen and no delayed
        -- theme transition: the settings button should feel instantaneous.
        setAccent(color)

        if context.PlayAdvancedThemeLoading then
            pcall(context.PlayAdvancedThemeLoading, color, "FISHHUB", "Theme applied")
        end
    end
